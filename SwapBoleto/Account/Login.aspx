<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="SwapMobileWWW.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Por favor, forneça seu usuário e senha.
        
    </p>
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false" 
    RenderOuterTable="false" onauthenticate="LoginUser_Authenticate" 
    FailureText="Não foi possível efetuar o seu login. Tente novamente.">
        <LayoutTemplate>
                ...
                <fieldset class="login">
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" 
                             CssClass="failureNotification" ErrorMessage="O usuário é obrigatório." ToolTip="O usuário é obrigatório." 
